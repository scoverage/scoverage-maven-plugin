try {
    ...
    assert !appAdminSkippedScoverageFile.exists(), "Skipped module (via property) should not generate scoverage.xml"

    def appAdminSkippedReportFile = new File(basedir, "apps/app-admin-skipped/target/site/scoverage/index.html")
    assert !appAdminSkippedReportFile.exists(), "Skipped module (via property) should not generate report"
